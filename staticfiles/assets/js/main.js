...
const typed = new Typed('.typed', {
    strings: [
        ...
        '<span class="word-change h1">Ganadería</span>',
        '<span class="word-change h1">aGuas</span>',
        '<span class="word-change h1">tecnoloGía</span>',
        '<span class="word-change h1">investiGación</span>',
        '<span class="word-change h1">inGeniería </span>',
